...
const INITIAL_SAMPLE_AUTOPARTS: AutoPart[] = [
  {
    ...
    partName: 'Mannol Defender 10W-40',
    code: 'MN7501-4',
    api: 'API SN/CH-4',
    liters: '4L',
    country: 'Germaniya',
    ...
    date: '2026-08-15',
    source: 'Rasmiy diler',
    comment: 'Yarim sintetik motor moyi, Cobalt va Gentra uchun',
  },
  {
    id: 'part_init_2',
    orderNumber: 2,
    ...
    comment: 'Original kanistrada, sifat kafolatlangan',
  },
  {
    id: 'part_init_3',
    orderNumber: 3,
    ...
    partName: 'Castrol Magnatec 5W-30',
    code: '15CA45',
    api: 'API SP / ILSAC GF-6',
    liters: '4L',
    country: 'Belgiya',
    brand: 'Castrol',
    supplierName: '"Avto Detal Servis" MCHJ',
    ...
    date: '2026-08-28',
    source: 'Rasmiy diler',
    comment: 'To\'liq sintetik import partiyasi',
  },
  {
    id: 'part_init_4',
    orderNumber: 4,
    ...
    date: '2026-09-02',
    source: 'Bozor',
    comment: 'Ulgurji narx chegirmasi bilan berildi',
  },
  {
    id: 'part_init_5',
    orderNumber: 5,
    ...
    date: '2026-09-08',
    source: 'Rasmiy diler',
    comment: 'Sintetik moy, oxirgi kelgan partiya',
  },
  {
    id: 'part_init_6',
    orderNumber: 6,
    ...
    partName: 'Shell Helix Ultra 5W-40',
    code: '550040755',
    api: 'API SP',
    liters: '4L',
    country: 'Germaniya',
    ...
    date: '2026-08-25',
    source: 'Ulgurji bozor',
    comment: 'PurePlus texnologiyasi asosida',
  },
  {
    id: 'part_init_7',
    orderNumber: 7,
    ...
    date: '2026-09-08',
    source: 'Do\'kon',
    comment: 'Rasmiy yetkazib berish, sertifikati bor',
  },
  {
    id: 'part_init_8',
    orderNumber: 8,
    ...
    partName: 'Mobil Super 3000 X1 5W-40',
    code: '152566',
    api: 'API SN/CF',
    liters: '4L',
    country: 'Fransiya',
    ...
    date: '2026-09-07',
    source: 'Import',
    comment: 'Yuqori sifatli to\'liq sintetik moy',
  },
];
